...
- **[nook](https://github.com/maxgfr/nook)** — Prise de notes local-first et chiffrée : rien ne quitte l'appareil, et la page elle-même s'interdit toute requête réseau (CSP connect-src 'none', vérifiée en CI). Clé AES-256-GCM non extractible, effacement total vérifiable — PWA hors-ligne. · [démo](https://maxgfr.github.io/nook/)
