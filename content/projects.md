...
- **[ultraprospect](https://github.com/maxgfr/ultraprospect)** — Transforme un lieu — ville, rue, rayon — en fichier de prospection défendable : balaie OpenStreetMap dans le monde entier et le registre français (SIRENE/RNE) sur le même territoire, fusionne les deux en une entité par entreprise, enrichit depuis le site de chacune (offres d'emploi lues via les API des ATS, sans navigateur) et refuse de deviner — lieu ambigu, appariement incertain, balayage partiel ou contact non observé font échouer le run. Zéro dépendance, aucune clé d'API.
